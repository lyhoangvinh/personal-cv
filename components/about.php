<section class="pt-page pt-page-2 hide" data-id="about_me">
                                ...
                                <div class="testimonials owl-carousel">
                                    ...
                                    <div class="testimonial-item" style="width:100%">
                                        ...
                                        <div class="testimonial-credits">
                                            <!-- Picture -->
                                            <div class="testimonial-picture">
                                                <img src="assets/images/testimonials/testimonial_photo_1.png" alt="">
                                            </div>              
                                            <!-- /Picture -->
                                            <!-- Testimonial author information -->
                                            <div class="testimonial-author-info">
                            ...
                            <div class="col-sm-6 col-md-3 subpage-block">
                                <div class="service-block"> 
                                    <div class="service-info">
                                        <img src="assets/images/service/web_design.png" alt="Responsive Design">
                                        <h4>Web Design</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_1.png" alt="image"></a>
                                </div>
                            </div>

                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_2.png" alt="image"></a>
                                </div>
                            </div>

                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_3.png" alt="image"></a>
                                </div>
                            </div>

                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_4.png" alt="image"></a>
                                </div>
                            </div>

                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_5.png" alt="image"></a>
                                </div>
                            </div>

                            <div class="col-sm-4 col-md-2 subpage-block">
                                <div class="client_block">
                                    <a href="#" target="_blank"><img src="assets/images/clients/client_6.png" alt="image"></a>
                                </div>
                            </div>
                        </div>
